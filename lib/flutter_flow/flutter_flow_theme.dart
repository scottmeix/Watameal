...
abstract class FlutterFlowTheme {
  ...
  late Color divider;
  late Color selectorFill;
  late Color unselectedHeadline;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFF2442);
  late Color secondary = const Color(0xFF00FFCD);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF333333);
  late Color secondaryText = const Color(0xFFFF2442);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFFAFAFA);
  late Color accent1 = const Color(0xFFFA2643);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF27DE24);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFF797979);

  late Color divider = const Color(0xFFDDDDDD);
  late Color selectorFill = const Color(0xFFF7F7F7);
  late Color unselectedHeadline = const Color(0xFF8C8C8C);
  late Color textFieldBackground = const Color(0xFFEFEFEF);
}
