...
import 'item_row_for_edit_model.dart';
export 'item_row_for_edit_model.dart';

class ItemRowForEditWidget extends StatefulWidget {
  const ItemRowForEditWidget({
    super.key,
    String? itemName,
    this.itemQuantity,
    this.itemUnit,
  ...
  @override
  State<ItemRowForEditWidget> createState() => _ItemRowForEditWidgetState();
}

class _ItemRowForEditWidgetState extends State<ItemRowForEditWidget> {
  late ItemRowForEditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ItemRowForEditModel());
