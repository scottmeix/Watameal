...
class ItemEditWidget extends StatefulWidget {
  const ItemEditWidget({super.key});
...
class _ItemEditWidgetState extends State<ItemEditWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??= TextEditingController(text: 'Banana Fried Skin');
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??= TextEditingController(text: '500');
                    ...
                    children: [
                      ...
                      FlutterFlowDropDown<String>(
                        controller: _model.dropDownValueController1 ??=
                          ...
                          _model.dropDownValue1 ??= 'g',
                        ),
                        options: ['g', 'kg', 'lb', 'oz', 'L'],
                        onChanged: (val) =>
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown<String>(
                      controller: _model.dropDownValueController2 ??=
                          FormFieldController<String>(
                        _model.dropDownValue2 ??= 'Ready to Eat',
                      ),
                      options: [
                        'Meat',
                        'Vegetable',
